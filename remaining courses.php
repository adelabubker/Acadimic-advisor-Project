...
$courses_query = "SELECT c.course_id, c.course_name, c.num_hour ,c.academic_year,c.have_prerequisite
                  ...
                  LEFT JOIN {$major}_enrollments AS e ON c.course_id = e.course_id AND e.student_id = $student_id WHERE e.course_id IS NULL OR (e.grade < 50 AND e.student_id = $student_id)"; 
